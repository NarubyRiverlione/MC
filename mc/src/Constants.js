const Cnst = {
  ...
  Ordnance: {
    AA: 'Anti Aircraft', G: ' Cruise Missle', AS: 'Anti Ship Missle', T: 'Torpedo', D: 'Defence',
  },
...
const ActionCnst = {
  ...
  Radio: {
    SelectSlot: 'RADIO_SELECT_SLOT',
    ExecuteCmd: 'RADIO_EXEC_CMD',
    NewMessage: 'RADIO_NEW_MSG',
    NewMessageTimedOut: 'RADIO_NEW_MSG_TIMEDOUT',
